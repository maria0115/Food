                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">칼로리 측정</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<!-- 						<p class="help-block">추론 할 이미지 선택 및 촬영</p> -->
						...
						<button type="submit" class="btn alazea-btn mt-15">Send Image</button>
					</div>
				</form>
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-12 col-md-12" style="text-align: center;">
                    ...
                    <div class="contact-information">
                        <p><span>음식명:</span> 피자</p>
                        <p><span>칼로리:</span> 300칼로리</p>
                        <p><span>음식의 정확도:</span> 퓽퓽퓽</p>

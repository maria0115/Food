(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("st_summary","402","154","388","80",null,null,null,null,"80",null,this);
            obj.set_taborder("6");
            obj.set_text("");
            obj.set_background("");
            obj.set_padding("5px");
            ...
            obj = new Static("Static02","Static01:5","105","180","24",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("");
            obj.set_background("");
            obj.set_padding("");
            ...
            obj = new Div("Div00","260","st_summary:8","530","164",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);

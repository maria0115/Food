...
<!-- 
									...
									<!-- 	<div class="col-12 col-md-6">
										...
										onclick="location.href='storeReviewDetailsmodify.do?b_no=${board.b_no}&s_brand_name=${board.s_brand_name}&title=${board.title}&userId=${board.userId}&b_content=${board.b_content}'" > 수정 </button>

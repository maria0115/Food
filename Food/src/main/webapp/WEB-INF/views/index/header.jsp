...
<link
	...
	rel="stylesheet">
<link rel="stylesheet"
	href="/Food/resources/css/v3/patternfly-adjusted.min.css">
<link rel="stylesheet"
	href="/Food/resources/css/v3/patternfly-additions.min.css">
					...
					<nav class="classy-navbar justify-content-between" id="alazeaNav">
						...
						<div class="classy-menu">
							...
							<div class="classynav">
								...
								<ul>
									<li><a href="/Food/todayMenu.do" id="today"
										style="font-size: 37px;">오늘의 메뉴</a></li>
									<li><a
										href="/Food/index/myMenu.do?m_id=${sessionScope.user_id}"
										id="mymenu" style="padding: 0 24px; font-size: 37px;">My
											Menu</a></li>
									<li><a href="/Food/index/choiceMenu.do" id="choice"
										style="font-size: 37px;">Other's Menu</a></li>
									<li><a href="/Food/index/mealFriends.do"
										style="font-size: 37px;">밥친구 만들기</a></li>
									<li><a href="/Food/index/store.do"
										style="font-size: 37px;">매장 정보</a></li>
									<li><a href="/Food/qnaboardList" style="font-size: 37px;">Q
											& A</a></li>
								</ul>
